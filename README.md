...
shortcut. See [CLAUDE.md](CLAUDE.md) for the actual working conventions
and content model I use to direct that work.
...
- Astro (content collections + MDX), static output
- Cloudflare Pages
- Beehiiv (email)
...
Add a new `.md` or `.mdx` file to `src/content/blog/` with this frontmatter:
...
Then write the post body in Markdown/MDX below the frontmatter.
